...
class CoverTemp2 extends StatefulWidget {
  const CoverTemp2({super.key});

  @override
  State<CoverTemp2> createState() => _CoverTemp2State();
}

class _CoverTemp2State extends State<CoverTemp2> {
  @override
  void initState() {
                  ...
                  children: [
                    pw.Text(
                        TemplateCoverHomeState.coverTemList['first_name'] +
                            " " +
                            TemplateCoverHomeState.coverTemList['last_name'],
                        style: const pw.TextStyle(
                          fontSize: 80,
                        )),
                    pw.SizedBox(height: 10),
                    pw.Text(TemplateCoverHomeState.coverTemList['job_title'],
                        style: const pw.TextStyle(
                          fontSize: 40,
                        )),
                    pw.Container(
